...
const projects = [
  ...
  },
  {
    ...
    description: "A production-ready full-stack e-commerce platform built with FastAPI (backend), React + Vite (frontend), and PostgreSQL. It features secure JWT-based authentication, product browsing, cart management, and order processing with persistent storage. The system includes role-based access control, where admins can view customer transactions and add, edit, or delete products. Designed with a scalable architecture, responsive UI (Tailwind CSS), and secure API communication.",
